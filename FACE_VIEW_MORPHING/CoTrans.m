...
%partition the image pixels into five different
%areas by griding
...
RA1 = ImWrap(A1x,A1y,face1,[1 1 F1E1(1)],[1 N F1E1(2)],[1 1 F2E1(1)],[1 N F2E1(2)]);  % use of inbuilt function to warp the areas accordingly 
%Index of area 2
...
%------------------------to see the 8 features rotating------------
%subplot(241);imshow(TRA1);
%subplot(242);imshow(TRA2);
%subplot(243);imshow(TRA3);
%subplot(244);imshow(TRA4);
%subplot(245);imshow(TRA5);
%subplot(246);imshow(TRA6);
%subplot(247);imshow(TRA7);
%subplot(248);imshow(TRA8);
%figure;
